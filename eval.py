...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=1.0,
    ...
    if args.display_masks and cfg.eval_mask_branch and num_dets_to_consider > 0:  # was ...>0
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        if args.cuda:
            net = net.cuda()
        print(' Done.')
        # torch.save(net, 'loaded_yolact_model.pt')
        net.eval()
